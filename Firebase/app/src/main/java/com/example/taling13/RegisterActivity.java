...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterId = findViewById(R.id.edt_enterID);
        enterPW = findViewById(R.id.edt_enterPW);
        enterPW2 = findViewById(R.id.edt_enterPW2);
        enterNick = findViewById(R.id.edt_enterNick);
        enterNum = findViewById(R.id.edt_enterNum);
